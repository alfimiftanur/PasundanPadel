    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
            ...
            <p class="mt-5 text-slate-700 max-w-md">
                Book your padel court in just a few clicks and 
                focus on what matters most "Playing the game".
            </p>
            <div class="mt-8 flex gap-4">
                <a href="/court"
                    class="inline-block text-sm uppercase tracking-wide border-b border-slate-900 pb-1">
                    Book Now
                </a>
            </div>
