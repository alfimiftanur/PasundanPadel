    ...
    <section id="courtlist" class="bg-amber-50 min-h-screen">
        <div class="max-w-7xl mx-auto px-6 py-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 min-h-[calc(100vh-160px)]">
                ...
                <!-- ================= FILTER SIDEBAR ================= -->
                <aside
                    class="md:col-span-1 sticky top-16 md:-mt-24 bg-teal-900/90 backdrop-blur rounded-3xl p-6 text-white shadow-lg min-h-[calc(100vh-220px)]">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="date"
                            class="w-full px-4 py-2 rounded-xl bg-white text-slate-900 focus:outline-none
